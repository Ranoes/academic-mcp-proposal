...
COPY canvas_validator.py builder_engine.py praproposal_builder.py server.py csv_ingestor.py topic_synthesizer.py diagram_generator.py formula_generator.py ./
